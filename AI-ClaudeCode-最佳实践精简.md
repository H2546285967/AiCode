...
> 完整功能说明见 `工作空间功能介绍.md`，操作细节见各脚本文档。
...
| **快照自动维护** | `node scripts/会话快照/save.js` | 跑完自动追加到 ROOT_快速加载会话.md |
...
工程已实现的几个核心系统，完整说明见 `工作空间功能介绍.md`：
...
| `工作空间功能介绍.md` | 完整功能说明 + 操作指南 |
| `自我进化循环系统设计.md` | **⭐ v1.8 新增：AI 每天从 GitHub 学习并本地实现新能力** |
